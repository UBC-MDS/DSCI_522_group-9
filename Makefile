...
data/raw/drug_consumption.csv: src/download_data.py
	python src/download_data.py --url=https://archive.ics.uci.edu/ml/machine-learning-databases/00373/drug_consumption.data --file_path=data/raw/drug_consumption.csv
...
results/feature_importances.png results/svc_dummy_score.csv results/test_results.csv: src/drug_consumption_prediction_model.py
