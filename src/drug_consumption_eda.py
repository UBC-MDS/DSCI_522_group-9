"""Creates eda plots for the pre-processed training data from the drug consumption dataset (from https://archive.ics.uci.edu/ml/machine-learning-databases/00373/drug_consumption.data).
